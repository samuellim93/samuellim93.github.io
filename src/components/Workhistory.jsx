  ...
  return (
    <div className='w-full h-auto bg-zinc-200'>
        <div className='max-w-7xl h-auto m-auto flex flex-col justify-center'>
            ...
            <div className='flex flex-col flex-wrap justify-center mx-20 py-5 md:items-center'>
                <strong className='text-2xl md:text-2xl'>💼 I Security ENGINEER @ M.TECH PRODUCTS PTE LTD</strong>
                <p>Year July 2021 - Present</p>
                <ul className='flex flex-col flex-wrap justify-center mx-20 md:items-start list-disc'>
                    ...
                    <li>Followed up with the clients during requirements gathering and run UAT session with the business users. ollowed up with the clients during requirements gathering and run UAT session with the business users.</li>
                </ul>
            </div>
            ...
            <div className='flex flex-col flex-wrap justify-center mx-20 md:items-center'> 
                ...
                <ul className='flex flex-col flex-wrap justify-center mx-20 py-5 md:items-start list-disc'>
